  ...
  return (
    <div className="post" id={personPost.id}>
      <div className="post__heading">
        ...
        <div className="post__heading--info">
          <div className="post__heading--personal-info">
            <p
              className={
                personPost.verifiedAccount
                  ? "post__heading--personal-info-check"
                  : ""
              }
            >
              {personPost.name}
      ...
      <div className="post__body">
        <img src={personPost.imageContent} className="post__body--content" alt={personPost.content} />
      </div>
      <div className="post__footer">
        <p className="post__footer--comments post-action">
          {personPost.comments}
        </p>
        <p
          className="post__footer--likes unlike post-action"
          onClick={() => likedPost(personPost)}
        >
          {personPost.likes}
        </p>
